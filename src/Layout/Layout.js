...
const Layout = () => {
  ...
  const navLinks = [
    ...
    { to: "/reports", icon: "summarize", label: "Reports", filled: true },
    ...
    <div className="flex flex-col gap-4 h-full">
      <div className="flex items-center gap-3">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCNagcnZIxCceF9RbaM3hNKle5UNO5TLPJzuU61Iz_UXbCtux4eG4Z1FhGDlbjyChyWKyMUy1ufZsLnaQIZutWL42CbThQsd0bTM_fneur8EQvPCVECMd0JR_dtxULUYNWANjehQM_AQp7KQWpVsL5yOV7JNVJgJIsLy0LFWageyQ8bGRgPNr63spkAUCmKAzefBBitcyIPXEr-qprqWR49KTlZ2HP9joqaMc6F6ds2xO75s5I4c6-HKSw9OJAoU6WarmzOFrTzyJFF")',
          }}
        ></div>
        <div className="flex flex-col">
          <h1 className="text-slate-900 dark:text-slate-200 text-base font-bold">SIRS</h1>
      ...
      <div className="flex flex-col gap-1 mt-auto">
        <button
          onClick={handleLogout}
          className="flex items-center gap-3 px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors w-full"
        >
          <span className="material-symbols-outlined">logout</span>
          <p className="text-sm font-medium">Log out</p>
        </button>
  ...
  return (
    <div className="flex min-h-screen w-full font-display bg-[#f6f7f8] dark:bg-[#101922]">
      ...
      {/* ─── Sidebar (Desktop) ─── */}
      <aside className="hidden md:flex h-screen flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-[#101922] w-64 p-4 sticky top-0 flex-shrink-0">
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-white dark:bg-[#101922] border-r border-slate-200 dark:border-slate-800 p-4 transform transition-transform duration-300 md:hidden ${
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile top bar */}
        <header className="md:hidden flex items-center gap-3 px-4 py-3 bg-white dark:bg-[#101922] border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30">
          <button
          ...
          <span className="text-slate-900 dark:text-slate-200 font-bold text-base">SIRS</span>
        </header>
